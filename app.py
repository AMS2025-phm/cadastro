...
class Unidade(db.Model):
    ...
    # NOVOS CAMPOS PARA MÚLTIPLOS PISOS E PAREDES NA UNIDADE
    tipos_piso_selecionados = db.Column(db.String(500)) # Armazena como string separada por vírgulas
    tipos_parede_selecionados = db.Column(db.String(500)) # Armazena como string separada por vírgulas
...
class Medida(db.Model):
    ...
    # REMOVIDOS: piso e parede, agora são da Unidade
...
def gerar_excel(dados_unidades):
    ...
    headers = [
        ...
        "Tipos de Piso", "Tipos de Parede", # NOVOS CAMPOS AQUI
        "Tipo Medida", "Largura (m)", "Altura (m)", "Área (m²)", "Quantidade"
    ]
    ...
    for unidade_data in dados_unidades:
        ...
        tipos_piso = unidade_data.get('tipos_piso_selecionados', '')
        tipos_parede = unidade_data.get('tipos_parede_selecionados', '')
        ...
        base_row = [
            ...
            tipos_piso, tipos_parede # NOVOS CAMPOS AQUI
        ]
...
def salvar_unidade():
    ...
    tipos_piso_selecionados = dados.get('tipos_piso_selecionados', '')
    tipos_parede_selecionados = dados.get('tipos_parede_selecionados', '')
    ...
    try:
        ...
        nova_unidade = Unidade(
            ...
            tipos_piso_selecionados=tipos_piso_selecionados,
            tipos_parede_selecionados=tipos_parede_selecionados
        )
        ...
        for unidade_db in todas_unidades_db:
            unidade_dict = {
                ...
                "tipos_piso_selecionados": unidade_db.tipos_piso_selecionados,
                "tipos_parede_selecionados": unidade_db.tipos_parede_selecionados,
                "medidas": []
            }
