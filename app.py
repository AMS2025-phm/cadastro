...
class Unidade(db.Model):
    ...
    # 'cascade="all, delete-orphan"' garante que medidas sejam deletadas se a unidade for deletada
...
with app.app_context():
    try:
        ...
        print(f"Error creating database tables during app context initialization: {e}")
        # Este erro pode impedir que o aplicativo inicie corretamente.
        # Para um aplicativo de produção, você desejaria um tratamento de erro mais robusto ou verificação de integridade.
...
# CORREÇÃO: Adicionando os tipos de medida que estavam faltando
